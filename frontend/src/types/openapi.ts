...
export interface components {
  schemas: {
     ...
     * @enum {unknown}
     */
    ChatModels: 'gpt-4' |'gpt-4-mobile' | 'gpt-4-browsing' | 'gpt-4-plugins' | 'text-davinci-002-render-sha-mobile' | 'text-davinci-002-render-sha' | 'text-davinci-002-render-paid' | '';
    /**
     * ChatStatus
     * @description An enumeration.
     * @enum {unknown}
